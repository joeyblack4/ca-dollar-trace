...
from .ingest.entities import run_entities
...
def _run_entities(storage: Storage, settings: Settings) -> None:
    cfg = load_source(settings, "entities")
...
def _run_sources_catalog(storage: Storage, settings: Settings) -> None:
    cfg = load_source(settings, "sources_catalog")
...
def _run_k12_apportionment(storage: Storage, settings: Settings) -> None:
    cfg = load_source(settings, "k12_apportionment")
